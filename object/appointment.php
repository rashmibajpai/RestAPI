...
class Appointment{
    ...
    $query = "SELECT a.a_id,p.p_id,p.p_fname,p.p_lname,p.p_emailid,p.p_phone,a.p_adate,a.p_atime,a.p_speciality,a.a_status FROM appointment a inner join patient p on p.p_id=a.p_id";
...
function readOne(){
   ...
   $query = "SELECT a.a_id,p.p_id,p.p_fname,p.p_lname,p.p_emailid,p.p_phone,a.p_adate,a.p_atime,a.p_speciality,a.a_status FROM appointment a inner join patient p on p.p_id=a.p_id WHERE a.a_id = ? ";
...
// used when filling up the update Appointment form
function readOneByPatient(){
 
    // select all query
    //$query = "SELECT * FROM appointment";
 
    $query = "SELECT a.a_id,p.p_id,p.p_fname,p.p_lname,p.p_emailid,p.p_phone,a.p_adate,a.p_atime,a.p_speciality,a.a_status FROM appointment a inner join patient p on p.p_id=a.p_id WHERE a.p_id = ? ";
